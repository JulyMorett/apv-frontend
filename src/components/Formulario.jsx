  ...
  return (
    <>
      ...
      <form className="bg-white py-10 px-5 mb-10 lg:mb-0 shadow-md rounded-md" onSubmit={handleSubmit}>
        <div className="mb-5">
          <label htmlFor="nombre" className="text-indigo-600 font-bold">Nombre de la Mascota</label>
        ...
        <div className="mb-5">
          <label htmlFor="propietario" className="text-indigo-600 font-bold">Nombre del Propietario</label>
        ...
        <div className="mb-5">
          <label htmlFor="email" className="text-indigo-600 font-bold">Email</label>
          <input  id="email" type="text" placeholder="Email de Contacto"
            className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
            value={email} onChange={e => setEmail(e.target.value)}/>
        </div>

        <div className="mb-5">
          <label htmlFor="fecha" className="text-indigo-600 font-bold">Fecha de Alta</label>
        ...
        <div className="mb-5">
          <label htmlFor="sintomas" className="text-indigo-600 font-bold">Síntomas</label>
          <textarea  id="sintomas" placeholder="Describe los Síntomas del Paciente"
            className="border-2 w-full p-2 mt-2 placeholder-gray-400 rounded-md"
