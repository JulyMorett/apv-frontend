            ...
            <div className="w-full md:w-1/2 bg-white shadow rounded-lg p-5">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="my-3">
                        ...
                        <input type="password" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg" name="new_pdw"
                    ...
                    <div className="my-3">
                        <label className="uppercase font-bold text-gray-600">Confirmar Nuevo Password</label>
                        <input type="password" className="border bg-gray-50 w-full p-2 mt-5 rounded-lg" name="confirm_pdw"
